...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="service-form">
            ...
            <div class="form-group">
				<label for="estimated_hours" class="control-label">Estimated Minutes</label>
                <input type="number" name="estimated_hours" id="estimated_hours" class="form-control" value="<?php echo isset($estimated_hours) ? round($estimated_hours * 60) : ''; ?>" step="1" min="0" placeholder="e.g., 150">
