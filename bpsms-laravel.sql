...
-- PHP Version: 8.0.7
create database laravel_new;
use laravel_new;
SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO";
START TRANSACTION;
SET time_zone = "+00:00";

SHOW TABLES LIKE 'product_list';
DROP TABLE IF EXISTS product_list;


CREATE TABLE bpsms_laravel_db.product_lists LIKE bpsms.product_lists;

INSERT INTO bpsms_laravel_db.product_lists
SELECT * FROM bpsms.product_lists;
...
SHOW TABLES LIKE 'brand_list';
SHOW CREATE TABLE brand_list;
--
...
DROP TABLE IF EXISTS cart_list, client_list, product_list;
SET FOREIGN_KEY_CHECKS = 1;
SHOW CREATE TABLE client_list;
